...
```bash
cd /Users/guweigang/Source/vphpext/vslim
./httpd/vhttpd --config /Users/guweigang/Source/vphpext/vslim/examples/config/laravel.toml
```

或位置参数简写：

```bash
./httpd/vhttpd /Users/guweigang/Source/vphpext/vslim/examples/config/laravel.toml
```
...
cmd = "php -d extension=/Users/guweigang/Source/vphpext/vslim/vslim.so /Users/guweigang/Source/vphpext/vslim/httpd/php-worker.php"

[worker.env]
VSLIM_HTTPD_APP = "/Users/guweigang/Source/vphpext/vslim/examples/laravel/app.php"
