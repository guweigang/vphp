...
PHP_FUNCTION(v_reverse_string) { v_reverse_string(execute_data, return_value); }
void v_logic_main(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_logic_main) { v_logic_main(execute_data, return_value); }
void v_add(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_add) { v_add(execute_data, return_value); }
void v_greet(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_greet) { v_greet(execute_data, return_value); }
void v_process_list(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_process_list) { v_process_list(execute_data, return_value); }
void v_test_map(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_test_map) { v_test_map(execute_data, return_value); }
void v_get_config(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_get_config) { v_get_config(execute_data, return_value); }
void v_get_user(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_get_user) { v_get_user(execute_data, return_value); }
void v_call_back(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_call_back) { v_call_back(execute_data, return_value); }
void v_new_coach(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_new_coach) { v_new_coach(execute_data, return_value); }
void v_new_db(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_new_db) { v_new_db(execute_data, return_value); }
void v_check_res(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_check_res) { v_check_res(execute_data, return_value); }
void v_analyze_fitness_data(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_analyze_fitness_data) { v_analyze_fitness_data(execute_data, return_value); }
void v_get_alerts(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_get_alerts) { v_get_alerts(execute_data, return_value); }
void v_complex_test(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_complex_test) { v_complex_test(execute_data, return_value); }
void v_analyze_user_object(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_analyze_user_object) { v_analyze_user_object(execute_data, return_value); }
void v_trigger_user_action(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_trigger_user_action) { v_trigger_user_action(execute_data, return_value); }
void v_call_php_closure(zend_execute_data *execute_data, zval *return_value);
PHP_FUNCTION(v_call_php_closure) { v_call_php_closure(execute_data, return_value); }
