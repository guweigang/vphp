...
```bash
PORT=19882 POOL_SIZE=6 bash /Users/guweigang/Source/vphpext/vhttpd/bench/run_host_regression.sh
```

Skip k6 and only verify lifecycle:

```bash
RUN_K6=0 bash /Users/guweigang/Source/vphpext/vhttpd/bench/run_host_regression.sh
```

Using unified names:

```bash
VHTTPD_PORT=19882 VHTTPD_WORKER_POOL_SIZE=6 bash /Users/guweigang/Source/vphpext/vhttpd/bench/run_host_regression.sh
...
```bash
k6 run /Users/guweigang/Source/vphpext/vhttpd/bench/k6_short.js
```
...
VSLIM_HTTPD_APP=/Users/guweigang/Source/vphpext/vhttpd/examples/stream-bench-app.php make serve
```
...
k6 run /Users/guweigang/Source/vphpext/vhttpd/bench/k6_stream.js
```
