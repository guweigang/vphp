...
require_once __DIR__ . '/package/src/Psr7Bridge.php';
require_once __DIR__ . '/package/src/SlimPsr7Adapter.php';
require_once __DIR__ . '/package/src/PhpWorker/StreamResponse.php';
require_once __DIR__ . '/package/src/PhpWorker/Server.php';
require_once __DIR__ . '/package/src/legacy_aliases.php';
...
$worker = new \VHttpd\PhpWorker\Server($socket, __DIR__ . '/app.php');
$worker->run();
